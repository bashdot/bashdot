...
**bashdot** is a minimalist dotfile management framework, supporting multiple profiles and templates, provided
...
It is designeed with simplicity, brevity, rich logging and comprehensive
